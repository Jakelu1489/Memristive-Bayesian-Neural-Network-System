...
HD_PWD='D:/zynq_tdc/tdc_system_prj/tdc_system_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_blk_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_blk_wrapper.tcl -notrace
