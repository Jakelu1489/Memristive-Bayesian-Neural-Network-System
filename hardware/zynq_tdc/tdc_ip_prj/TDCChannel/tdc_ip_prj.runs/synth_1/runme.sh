...
HD_PWD='D:/zynq_tdc/tdc_ip_prj/tdc_ip_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TDCchannel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TDCchannel.tcl
