...
HD_PWD='D:/zynq_tdc/tdc_ip_prj/tdc_ip_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDCchannel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDCchannel.tcl -notrace
