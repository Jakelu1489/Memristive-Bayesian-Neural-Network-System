...
-- Author: Liu Yanxu
-- Created: 23.5.2024
-- Modified: 23.5.2024 (remove control )
...
--      ADDR_WIDTH : integer := 11    -- BRAM buffer address size
   ...
   Port ( 
      ...
      DLenable : in std_logic;  -- Delay line enable
      ValidOut : out std_logic;
      timestamp :out std_logic_vector(31 downto 0)  -- timestamp
--      -- BRAM interface
...
--   signal validIn, validOut : std_logic; -- TDC timestamp valid
   signal validIn : std_logic; -- TDC timestamp valid
