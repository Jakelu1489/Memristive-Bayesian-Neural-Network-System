...
HD_PWD='D:/zynq_tdc/tdc_system_prj/tdc_system_prj.runs/zynq_blk_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_blk_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_blk_axi_dma_0_0.tcl
