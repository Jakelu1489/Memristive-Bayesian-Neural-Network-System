...
#
# Generated by export_simulation on Fri Jul 12 16:32:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './zynq_blk.sh' script.

./zynq_blk.sh -reset_run
...
./zynq_blk.sh -noclean_files

For more information on the script, please type './zynq_blk.sh -help'.
