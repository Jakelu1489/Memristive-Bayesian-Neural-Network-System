...
#
# Generated by export_simulation on Fri May 24 11:19:11 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './TDCchannel_0.sh' script.

./TDCchannel_0.sh -reset_run
...
./TDCchannel_0.sh -noclean_files

For more information on the script, please type './TDCchannel_0.sh -help'.
